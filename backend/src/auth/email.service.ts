...
export class EmailService {
  ...
  constructor() {
    this.transporter = nodemailer.createTransport({
      ...
      auth: {
        user: 'gobinathgobinath643@gmail.com',
        pass: 'zwzf vpmr wkoa gngs',
      },
    });
  }
  ...
  async sendOtpEmail(to: string, name: string, otp: string) {
    const htmlTemplate = `
      ...
      <body style="margin: 0; padding: 40px 0; background-color: #f4f4f4; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="300" style="background-color: #ffffff; border-radius: 15px; box-shadow: 0 4px 30px rgba(0,0,0,0.1); border-collapse: separate; overflow: hidden;">
          <tr>
            <td align="center" style="padding-top: 40px; padding-bottom: 10px;">
              <p style="margin: 0; font-size: 18px; font-weight: bold; color: #000000; text-transform: uppercase; letter-spacing: 2px;">Verify</p>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding-bottom: 30px;">
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="none" viewBox="0 0 24 24" id="verified" style="display: block;">
          ...
          <tr>
            <td align="center" style="padding: 0 20px 40px 20px;">
              <table border="0" cellpadding="0" cellspacing="10" style="margin: 0 auto;">
                <tr>
                  <td align="center" style="width: 40px; height: 40px; background-color: #f0f0f0; border-radius: 5px; font-size: 24px; font-weight: bold; color: #333333; font-family: monospace;">${otp[0]}</td>
                  <td align="center" style="width: 40px; height: 40px; background-color: #f0f0f0; border-radius: 5px; font-size: 24px; font-weight: bold; color: #333333; font-family: monospace;">${otp[1]}</td>
                  <td align="center" style="width: 40px; height: 40px; background-color: #f0f0f0; border-radius: 5px; font-size: 24px; font-weight: bold; color: #333333; font-family: monospace;">${otp[2]}</td>
                  <td align="center" style="width: 40px; height: 40px; background-color: #f0f0f0; border-radius: 5px; font-size: 24px; font-weight: bold; color: #333333; font-family: monospace;">${otp[3]}</td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding-bottom: 20px;">
              <p style="margin: 0; font-size: 10px; color: #999999; text-transform: uppercase; letter-spacing: 1px;">Global Knowledge Technologies</p>
            </td>
          </tr>
        </table>
      </body>
    ...
    await this.transporter.sendMail({
      from: '"AI Camp Registration" <gobinathgobinath643@gmail.com>',
      to,
